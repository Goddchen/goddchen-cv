...
class GithubPrsModelUpdatedCause extends Cause {
  final GithubPrsModel model;

  GithubPrsModelUpdatedCause(this.model);
}

class OpenGithubPrCause extends Cause {
  final GithubPrsModelPr pr;

  OpenGithubPrCause(this.pr);
}
